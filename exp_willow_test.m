...
base_folder = './data/willow/';
objs = {'Car', 'Duck', 'Face', 'Motorbike', 'Winebottle'};
%%
itr_num = 500;
graph_num_list = 3:3:15;
...
for k = 1:length(objs)
    ...
    save(['./results/willow_', obj, '.mat'], 'acc');
    figure, plot(graph_num_list, acc);
    legend(alglist);
    drawnow;
    toc;
end
